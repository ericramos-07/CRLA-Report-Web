...
def calculate_percentage(df, part_col, total_col):
    """Safely calculates a percentage between two columns."""
...
def process_crla(df, group_column):
    # [Keep all your exact columns_to_sum, grouped logic, and percentage logic here]
    # For brevity in this example, assuming the exact same logic as your original script
...
# Step 1: Ask the user which term they are processing using a web radio button
term_name = st.radio("Which term are you processing?", ("BoSY", "EoSY"))

# Step 2: Web File Uploader
